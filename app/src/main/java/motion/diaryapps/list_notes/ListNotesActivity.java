...
public class ListNotesActivity extends AppCompatActivity {
    ...
    public void initRecyclerView() {
        ...
        mAdapter = new ListNotesAdapter(mLists,null);
    ...
    public ListNotesActivity(List<ListNotesModel> mLists) {
        this.mLists = mLists;
    }
    ...
    public void initDummy() {
        ...
        String title = null;
        String date;
        date = Tools.getCurrentDateISO8601();

        mLists.add(new ListNotesModel(id,image_url,title,date));
